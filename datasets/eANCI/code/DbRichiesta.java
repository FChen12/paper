...
private Connection connection;
	...
	public DbRichiesta() throws DbEccezione
	{
		try
		{
	 ...
	 * @throws DbEccezione
	 */
	public boolean inserisciRichiesta(Richiesta ric)throws DbEccezione
	{
		int ret=0;
		PreparedStatement statement=null;
		String tipo=ric.ottenereTipo();
		String data=ric.ottenereData();
		int richiedente=ric.ottenereRichiedente();
		String stato=ric.ottenereStato();
		String documento=ric.ottenereDocumento();
		try
		{
		...
		{
			throw new DbEccezione("Errore: inserimento richiesta non riuscito");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public boolean eliminaRichiesta(int id) throws DbEccezione
	{	
		PreparedStatement statement=null;
		int ret=0;
		try
		...
		{
			throw new DbEccezione("Errore: cancellazione richiesta non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Richiesta ottenereRichiestaPerId(int id)throws DbEccezione
	{
		PreparedStatement statement=null;
		ResultSet rs=null;
		Richiesta ret=null;
		...
		{
			throw new DbEccezione("Errore: ricerca tramite l'id della richiesta non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Collection<Richiesta> ottenereRichiestaPerRichiedente(int idR)throws DbEccezione
	{
		...
		{
			throw new DbEccezione("Errore: ricerca richieste tramite l'id del richiedente non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Collection<Richiesta> ottenereRichiestaPerStato(int idR, String stato) throws DbEccezione
	{
		ArrayList<Richiesta> ret = new ArrayList<Richiesta>(); 
		PreparedStatement statement=null;
		ResultSet rs=null;
		...
		{
			throw new DbEccezione("Errore: ricerca richieste tramite l'id del richiedente e stato richiesta non riuscita");
		}
		finally
		{
			try
			...
			{
				throw new DbEccezione("Errore: ricerca tramite l'id del richiedente e stato richiesta non riuscita ");
			}
		}
	}
	 ...
	 * @throws DbEccezione
	 */
	public Collection<Richiesta> ottenereRichiestaPerTipo(int idR, String tipo) throws DbEccezione
	{
		ArrayList<Richiesta> ret = new ArrayList<Richiesta>(); 
		PreparedStatement statement=null;
		ResultSet rs=null;
		...
		{
			throw new DbEccezione("Errore: ricerca richieste tramite l'id del richiedente e tipo richiesta non riuscita");
		}
		finally
		{
			try
			...
			{
				throw new DbEccezione("Errore: ricerca tramite l'id del richiedente e tipo richiesta non riuscita ");
			}
		}
	}
	 ...
	 * @throws SQLException
	 */
	public boolean settareStatoRichiesta(int idR, String stato)throws DbEccezione
	{
		PreparedStatement statement=null;
		int ret=0;
		try
		...
		{
			throw new DbEccezione("Errore: modifica stato richiesta non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Collection<Richiesta> ottenereRichieste() throws DbEccezione
	{
		ArrayList<Richiesta> ret = new ArrayList<Richiesta>(); 
		PreparedStatement statement=null;
		ResultSet rs=null;
		...
		{
			throw new DbEccezione("Errore: ricerca richieste non riuscita");
		}
		finally
		{
			try
