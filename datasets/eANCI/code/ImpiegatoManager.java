...
public class ImpiegatoManager {
	 ...
	 */
	public boolean modificaImpiegato(String matricola, Impiegato nuovoImpiegato)throws DbEccezione{
		return dbImpiegato.modificaImpiegato(matricola, nuovoImpiegato);
	}
	/**
	 ...
	 * @throws DbEccezione
	 */
	public Impiegato ricercaImpiegatoByMatricola(String matricola) throws DbEccezione{
		return dbImpiegato.ottenereImpiegatoPerMatricola(matricola);
	}
	/**
	 ...
	 * @throws DbEccezione
	 */
	public boolean inserisciImpiegato(Impiegato nuovoImpiegato)throws DbEccezione{
		return dbImpiegato.inserisciImpiegato(nuovoImpiegato);
	}
	/**
	 ...
	 * @throws DbEccezione
	 */
	public boolean eliminaImpiegato(String matricola)throws DbEccezione{
	 ...
	 * @throws DbEccezione
	 */
	public Impiegato ottenereImpiegatoPerLogin(String login) throws DbEccezione{
		return dbImpiegato.ottenereImpiegatoPerLogin(login);
	}
	...
	public Collection<Impiegato> ottenereImpiegatoPerNome(String nomeImp,String cognImp) throws DbEccezione{
		return dbImpiegato.ottenereImpiegatoPerNome(nomeImp, cognImp);
	}
	/**
	...
	public Collection<Impiegato> ottenereImpiegati() throws DbEccezione{
		return dbImpiegato.ottenereImpiegati();
	}
}
