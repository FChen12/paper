		...
		throws ServletException,IOException{
			...
			if(session!=null){
				...
				try{
					 ...
					 * 		li prende con richiesta.getParameter
					 ...
					 * 		quest'ultimo.
					 */
					String cod_carta=richiesta.getParameter("cod_carta");
					String data=richiesta.getParameter("year").concat(richiesta.getParameter("month").concat(richiesta.getParameter("day")));
					/**
					...
					idCittadino=dbcarta.ricercaCartaIdentitaPerNumero(cod_carta).id();
					String risp;
					if(idCittadino==-1){
						risp="Non è possibile recuperare l'id del cittadino all'interno del database";
						risposta.sendRedirect("http://localhost:8080/E_ANCI/index.jsp?error=e");//da modificare i collegamenti
						richiesta.setAttribute("risp", risp);
					}
					else{
						/**
