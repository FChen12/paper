...
public class DbAmministratore {
	...
	public DbAmministratore() throws DbEccezione
	{
		try
		{
	 ...
	 * @throws DbEccezione
	 */
	public boolean inserisciAmministratore(Amministratore a)throws DbEccezione
	{
		String matr=a.ottenereMatricola();
		...
		{
			throw new DbEccezione("Errore: inserimento amministratore non riuscito");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public boolean eliminaAmministratore(String  matr) throws DbEccezione
	{
		PreparedStatement statement=null;
		int ret=0;
		try
		...
		{
			throw new DbEccezione("Errore: cancellazione amministratore non riuscita");
		}
		finally
		{
			try
	...
	public Collection<Amministratore> ottenereAmministratorePerNome(String nomeAmm,String cognAmm) throws DbEccezione
	{
		...
		{
			throw new DbEccezione("Errore: ricerca amministratore tramite nome e cognome non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Amministratore ottenereAmministratorePerMatricola(String matrAmm) throws DbEccezione
	{
		PreparedStatement statement=null;
		ResultSet rs=null;
		...
		{
			throw new DbEccezione("Errore: ricerca amministratore tramite matricola non riuscita");
		}
		finally
		{	
			try
	...
	public Collection<Amministratore> ottenereAmministratori() throws DbEccezione
	{
		...
		{
			throw new DbEccezione("Errore: ricerca amministratori non riuscita");
		}
		finally
		{
			try
	 ...
	 * @throws DbEccezione
	 */
	public Amministratore ottenereAmministratorePerLogin(String log)throws DbEccezione
	{
		PreparedStatement statement=null;
		ResultSet rs=null;
		Amministratore ret=null;
		...
		{
			throw new DbEccezione("Errore: ricerca amministratore tramite login non riuscita");
		}
		finally
		{	
			try
	...
	public boolean modificaAmministratore(String matr, Amministratore a)
	{
		...
		{
			throw new DbEccezione("Errore: modifica amministratore non riuscita");
		}
		finally
		{
			try
