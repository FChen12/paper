...
public class Richiesta {
	 ...
	 */
	public int ottenereIdRichiesta() {
		return idRichiesta;
	}
	 ...
	 */
	public int settareIdRichiesta(int str) {
		idRichiesta = str;
		return str;
	}
	 ...
	 */
	public String settareTipo(String str) {
		tipo = str;
		return str;
	}
	 ...
	 */
	public String settareData(String str) {
		data = str;
		return str;
	}
	 ...
	 * @return	una stringa con l'id della richiesta
	 */
	public int ottenereRichiedente() {
		return richiedente;
	}
	 ...
	 */
	public int settareRichiedente(int str) {
		richiedente = str;
		return str;
	}
	 ...
	 * @return		una stringa che contiene la nuova data
	 */
	public String settareStato(String str) {
		stato = str;
		return str;
	}
	 ...
	 * @return	una stringa con l'id della richiesta
	 */
	public String ottenereDocumento() {
		return documento;
	}
	 ...
	 */
	public String settareDocumento(String str) {
		documento = str;
		return str;
	}
