...
public class ServletCreaPdfCertificati extends HttpServlet {
	...
	public void doPost(HttpServletRequest richiesta, HttpServletResponse risposta) 
		...
		String certificato	= richiesta.getParameter("certificato");
        String cognome		= richiesta.getParameter("cognome").toUpperCase();
		String nome			= richiesta.getParameter("nome").toUpperCase();
		String sesso		= richiesta.getParameter("sesso").toUpperCase();
		String nascita		= richiesta.getParameter("nascita").toUpperCase();
		String provincia	= richiesta.getParameter("provincia").toUpperCase();
		String residenza	= richiesta.getParameter("residenza").toUpperCase();
		String prov_res		= richiesta.getParameter("prov_res").toUpperCase();
		String data			= richiesta.getParameter("data");
		String indirizzo	= richiesta.getParameter("indirizzo").toUpperCase();
		String dichiara_x 	= richiesta.getParameter("dichiara").toUpperCase();
