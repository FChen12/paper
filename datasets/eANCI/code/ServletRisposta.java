...
public class ServletRisposta extends HttpServlet{
	 ...
	 */
	public void doPost(HttpServletRequest richiesta, HttpServletResponse risposta)throws IOException,ServletException{
		...
		int idCitt = ((Cittadino)session.getAttribute("c")).ottenereIdCittadino();
		String inout = "";
		...
		try {
			...
			risposta.sendRedirect("/myDoc/user/home.jsp?func=risposta&page=utente");
			document.open();
